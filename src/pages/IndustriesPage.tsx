...
const IndustriesPage: React.FC = () => {
  ...
  const industries = [
    {
      ...
      example: 'Essential consumer products with consistent market demand',
    ...
    },
    {
      ...
      example: 'LIVE: ₹2.2 Cr Hajipur Spice Factory - Profitable & Distributing Returns',
    ...
    },
    {
      ...
      example: 'Critical healthcare sector with growing demand and social impact',
    ...
    },
    {
      ...
      example: 'Traditional sector with modern manufacturing and export potential',
    ...
    },
    {
      ...
      example: 'Rapidly growing tech sector with Make in India opportunities',
    ...
    },
    {
      ...
      example: 'Sustainable packaging solutions for booming e-commerce industry',
    ...
    },
    {
      ...
      example: 'Skill development centers creating employable workforce',
    ...
    },
    {
      ...
      example: 'LIVE: ₹45 Lakh Agra Supermarket - Successfully Operating',
    ...
    },
    {
      ...
      example: 'Essential infrastructure supporting agricultural and food sectors',
    ...
    },
    {
      ...
      example: 'Supporting India\'s mineral wealth extraction and processing',
    ...
    },
    {
      ...
      example: 'Thriving automotive ecosystem with global export opportunities',
      color: 'bg-blue-600/20 text-blue-400',
      borderColor: 'border-blue-600/50',
  ...
  const successMetrics = [
    ...
    { label: 'Live Projects', value: '2+', icon: Rocket, image: 'assets/sliderHeader.webp' },
    { label: 'Direct Jobs', value: '80+', icon: Heart, image: 'https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=400' },
    { label: 'Community Investment', value: '₹2.95 Cr', icon: Sparkles, image: 'https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=400' }
  ]
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          <AnimatedSection className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-5xl mx-auto leading-relaxed">
              ...
              that creates jobs, serves communities, and generates sustainable profits, we want to partner with you.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection className="cyber-card p-12 text-center backdrop-blur-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
                From traditional handicrafts to cutting-edge technology, from local services to export-oriented manufacturing — 
                we support diverse industrial ventures that create value for communities.
      ...
      <section className="py-24 bg-gradient-to-r from-black via-primary-600/10 to-black text-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          <AnimatedSection>
            ...
            <p className="text-xl mb-12 text-primary-100 max-w-5xl mx-auto leading-relaxed">
